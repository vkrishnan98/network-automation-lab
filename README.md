...
A production grade logging and exceptional handling code using python and logging libraries

## 🎯 Project Goal
 simulation of connection attempt and the logging and exceptional handling aspect on a device
